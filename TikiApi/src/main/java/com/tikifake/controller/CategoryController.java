...
//		CategoryCreator categoryResponse = categoryService.save(categoryCreator);
//		return ResponseEntity.ok().body(categoryResponse);
//	}
//	
//	@RequestMapping(value = "/addList", method = RequestMethod.POST)
//	public ResponseEntity<Object> addList(@RequestBody List<CategoryCreator> categoryCreators){
//		List<CategoryCreator> response = new ArrayList<>();
//		
...
//		CategoryCreator categoryResponse = categoryService.update(categoryUpdate);
//		
